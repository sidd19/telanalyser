...
#define transrelaypos 11
#define transrelayneg 12


#define manbut 20
#define dtmfbutton 21
#define ringbutton 22
#define recbutton 23
#define trabutton 24
#define ansbutton 25


#define teltestcalleridswitch 26
#define inoutcallswitch 27
#define repeatcallswitch 28
#define manautoswitch  29


#define d0  31//output of dtmf module to uC 
#define d1  32// "
#define d2  33// "
#define d3  34// "

//#define calleridrelay 9
//#define calleridbutton 12
...
int dialidbtest()
{
  ...
  int a;
   ...
   a = digitalRead(teltestcalleridswitch);
   //teltestcalleridswitch = 1; 
  // if (a == 0)
  //{
    //activate idp mode
  //}
  if (teltestcalleridswitch == 1)
  {
